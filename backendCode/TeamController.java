...
public class TeamController {
   ...
   public Team getById(@PathVariable String teamname) {
	...
	@PutMapping("/{playername}/{score}/{prev_score}")
    public long saveScore( @RequestBody Player player, @PathVariable String playername,@PathVariable Long score , @PathVariable Long prev_score) 
	 {
	   return  repos.updateScore(playername,score,prev_score);
		 
	 }
	
	 @GetMapping("/players/score")
	 public List<Player> retreivePlayersScore()
		{   
			return repos.findPlayersScore();
	    }
